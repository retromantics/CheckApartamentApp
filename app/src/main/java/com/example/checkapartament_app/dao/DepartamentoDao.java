...
public interface DepartamentoDao {
    ...
    @Insert
    void addLAll(Departamento...d);
    @Update
    void update(Departamento d);
    @Delete
    void delete(Departamento d);
    @Query("select dptoId, proyecto, nro_departamento,  direccion,   estado_gral from departamento_table")
    List<Departamento> list();
    @Query("select  dptoId, proyecto, nro_departamento,  direccion, estado_gral from departamento_table where dptoId= :id")
